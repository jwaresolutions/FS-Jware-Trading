...
api.list_orders(status='all', after='2021-05-14T13:30:00Z')
...
for symbol in symbols:
    ...
    opening_range_high = opening_range_bars[symbol]['low'].max()
    ...
    current_price = after_opening_range_bars[symbol].iloc[0]['close']
    ...
    # Breakdown Logic
        ...
        print(f"{symbol} did not match this strategy at {current_date}")
